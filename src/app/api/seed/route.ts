...
export async function POST() {
  try {
    ...
    await Promise.all([
      db.blogPost.upsert({
        where: { slug: 'saturn-retrograde-2025-impact' },
        update: {},
        create: {
          slug: 'saturn-retrograde-2025-impact',
          title: 'Saturn Retrograde 2025: Impact on NEPSE Markets',
          excerpt: 'Analyzing the potential impact of Saturn retrograde on Nepal Stock Exchange trends.',
          content: 'Saturn retrograde periods have historically shown correlation with market volatility. In 2025, Saturn will retrograde through Aquarius, which traditionally affects banking and financial sectors.',
          status: 'PUBLISHED',
          authorId: editor.id,
      ...
      db.blogPost.upsert({
        ...
        create: {
          ...
          title: 'Weekly Market Forecast: June 16-20',
    ...
    const vedicEvents = await Promise.all([
      db.vedicEvent.upsert({
        ...
        create: {
          ...
          name: 'Saturn Retrograde in Aquarius',
          eventType: 'RETROGRADE',
          planet: 'Saturn',
          startDate: new Date('2025-06-01'),
          endDate: new Date('2025-10-15'),
          description: 'Saturn retrograde in Aquarius traditionally affects banking and financial sectors. Historical data shows increased volatility during this period.',
    ...
    await Promise.all([
      ...
      db.marketPrediction.create({
        data: {
          ...
          targetDate: new Date('2025-06-04'),
        },
      }),
      db.marketPrediction.create({
        data: {
          ...
          targetDate: new Date('2025-09-14'),
        },
      }),
    ])
    ...
    await Promise.all([
      ...
      db.activityLog.create({
        data: {
          ...
          details: 'Published: Saturn Retrograde 2025 Impact',
